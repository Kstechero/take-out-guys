...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='AI session';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Dish review';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Dish review like';
...
CREATE TABLE IF NOT EXISTS `customer_service_session` (
  ...
  `status` int NOT NULL DEFAULT '1' COMMENT '1 open 2 closed',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Customer service session';
