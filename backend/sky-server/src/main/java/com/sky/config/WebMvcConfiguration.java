...
import com.sky.interceptor.InternalAgentAuthInterceptor;
...
public class WebMvcConfiguration extends WebMvcConfigurationSupport {
    ...
    @Autowired
    private InternalAgentAuthInterceptor internalAgentAuthInterceptor;
    ...
    /** Apifox 可直接导入的完整分组，覆盖 admin、user 和 notify Controller。 */
    @Bean
    public Docket docketAll() {
        ApiInfo apiInfo = new ApiInfoBuilder()
                .title("Takeout Guys 全部后端接口")
                .version("2.0")
                .description("Apifox/Swagger 完整接口文档")
                .build();
