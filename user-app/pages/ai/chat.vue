	...
	methods: {
		...
		async send(text) {
			...
			try {
				...
				answer.content = error?.msg || '智能客服暂时不可用，请稍后再试。若问题较复杂，建议在人工客服工作时间 10:00-22:00 联系人工客服。'
			} finally {
				this.loading = false
			}
		}
...
.chat-page{height:100%;background:#f7f6f2;display:flex;flex-direction:column}.agent-head{min-height:126rpx;padding:20rpx 28rpx;background:#101a2a;color:#fff;display:flex;align-items:center;box-sizing:border-box}.agent-head image{width:78rpx;height:78rpx;border-radius:22rpx;margin-right:18rpx}.agent-head>view:nth-child(2){display:flex;flex-direction:column;flex:1}.name{font-size:29rpx;font-weight:700}.state{font-size:20rpx;color:#8f9baa}.state i{display:inline-block;width:12rpx;height:12rpx;border-radius:50%;background:#58d68d;margin-right:8rpx}.head-actions{display:flex;flex-direction:column;align-items:flex-end;gap:10rpx}.history-link{font-size:21rpx;color:#cfd6df}.recommend-link{padding:10rpx 18rpx;background:#ff4b12;border-radius:22rpx;font-size:21rpx}.session-panel{padding:18rpx 24rpx;background:#fff;border-bottom:1rpx solid #ecebe7}.session-panel-head{display:flex;justify-content:space-between;align-items:center;font-size:24rpx;font-weight:700;color:#101a2a}.new-session{color:#ff4b12;font-weight:600}.session-empty{padding:26rpx 0 10rpx;color:#8b938e;font-size:22rpx}.session-list{display:flex;flex-direction:column;gap:14rpx;margin-top:18rpx}.session-item{display:flex;align-items:center;justify-content:space-between;padding:18rpx 20rpx;background:#f6f6f2;border-radius:20rpx}.session-item.active{background:#fff1eb;border:1rpx solid #ffd2c4}.session-meta{display:flex;flex:1;flex-direction:column;overflow:hidden}.session-title{font-size:24rpx;color:#182232;white-space:nowrap;text-overflow:ellipsis;overflow:hidden}.session-desc{margin-top:6rpx;font-size:20rpx;color:#8d948f}.session-delete{margin-left:16rpx;color:#d94b1e;font-size:22rpx}.messages{flex:1;height:0;padding:28rpx 24rpx;box-sizing:border-box}.message{display:flex;align-items:flex-start;margin-bottom:25rpx}.message image{width:58rpx;height:58rpx;border-radius:17rpx;margin-right:12rpx}.message.user{justify-content:flex-end}.bubble{max-width:72%;padding:20rpx 23rpx;background:#fff;border-radius:8rpx 26rpx 26rpx 26rpx;box-shadow:0 7rpx 22rpx rgba(16,26,42,.06);font-size:26rpx;line-height:1.65}.user .bubble{background:#ff4b12;color:#fff;border-radius:26rpx 8rpx 26rpx 26rpx}.cursor{color:#ff4b12}.quick-title{font-size:21rpx;color:#969d99;margin:35rpx 0 12rpx 70rpx}.quick-list{margin-left:70rpx}.quick-list view{display:inline-block;padding:11rpx 17rpx;margin:0 8rpx 10rpx 0;background:#fff;border:1rpx solid #e7e8e4;border-radius:24rpx;color:#5f6963;font-size:21rpx}.bottom-space{height:30rpx}.composer{display:flex;align-items:flex-end;padding:18rpx 22rpx calc(18rpx + env(safe-area-inset-bottom));background:#fff;border-top:1rpx solid #e8e8e5}.composer textarea{flex:1;min-height:42rpx;max-height:150rpx;padding:17rpx 20rpx;background:#f3f4f0;border-radius:24rpx;font-size:25rpx;line-height:1.45}.composer button{width:112rpx;height:72rpx;line-height:72rpx;margin:0 0 0 14rpx;padding:0;background:#ff4b12;color:#fff;border-radius:24rpx;font-size:24rpx}.composer button[disabled]{opacity:.45}
</style>
